...
#background image
homepage_bg_image = pygame.image.load(os.path.join(os.getcwd(), "C:/Users/Arvind/Desktop/DTU 1st year/OSP/homepage_bg.png"))
homepage_bg_image = pygame.transform.scale(homepage_bg_image, (window_width, window_height))

arcade_bg_image = pygame.image.load(os.path.join(os.getcwd(), "C:/Users/Arvind/Desktop/DTU 1st year/OSP/arcade_bg.png"))
...
def launch_game_1():
    subprocess.Popen(["python", "C:/Users/Arvind/Desktop/DTU 1st year/OSP/memorypuzzle.py"])

def launch_game_2():
    subprocess.Popen(["python", "C:/Users/Arvind/Desktop/DTU 1st year/OSP/slidepuzzle.py"])

def launch_game_3():
    subprocess.Popen(["python", "C:/Users/Arvind/Desktop/DTU 1st year/OSP/testing.py"])

def launch_game_4():
    subprocess.Popen(["python", "C:/Users/Arvind/Desktop/DTU 1st year/OSP/wormyyy.py"])
